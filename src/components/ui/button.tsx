  ...
  "inline-flex items-center justify-center rounded-full text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        outline: "border border-primary-200 bg-white hover:bg-primary-50 text-primary-700 active:scale-95",
        secondary: "bg-secondary-100 text-secondary-700 hover:bg-secondary-200 active:scale-95",
        ghost: "hover:bg-secondary-100 text-secondary-600 hover:text-secondary-700 active:scale-95",
